...
const Navbar = () => {
  ...
  return (
    <nav className="sricky top-0 z-50 py-3 backdrop-blur-lg border-b border-neutral-700/80">
      <div className="container px-4 mx-auto relative text-small">
        <div className="flex justify-between item-center">
          ...
          <div className="hidden lg:flex justfify-center space-x-12 items-center">
            <a
